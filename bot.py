...
async def cmd_start(message: types.Message):
    ...
    save_settings(
        ...
        "salom",
        "Assalomu alaykum! Biznes botimizga xush kelibsiz. Tez orada javob beramiz."
    )

    text = (
        "👋 Salom! Biznes platformaga xush kelibsiz.\n\n"
        "⚙️ Standart sozlama saqlandi:\n"
        "🔹 Trigger: salom\n"
        "🔹 Javob: Assalomu alaykum! Biznes botimizga xush kelibsiz...\n\n"
        "🔌 Telegram Business -> Chatbots bo'limidan ushbu botni ulang."
    )
        ...
        try:
            await bot.send_message(
                ...
                text=(
                    ...
                    "Endi mijozlaringiz yozganda bot avtomatik javob beradi."
                )
            )
...
async def handle_business_message(message: types.Message):
    ...
    if reply_text:
        try:
            ...
            logging.info(f"Avto javob yuborildi: {client_chat_id}")
...
async def on_startup(app):
    ...
    try:
        ...
        logging.error(f"Flood limit: {e.retry_after}")
